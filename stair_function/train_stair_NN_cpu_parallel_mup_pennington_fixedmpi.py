...
def main():
    ...
    # Parameters 
    experiment_name = "msp_NN_grid_0501_mup_lr0005"
    P = 8 
    d = 30
    master_size = 60000  # Size of master training set
    hidden_sizes =  [1500,10,20,30,2000,50,75,5000,40,8000]
    #hidden_sizes = [3000,85,150,200,300,400,500,600,800,1000,120,100,4000]
    #hidden_sizes = [3000,85,150,200,300,400,500,600]
    #hidden_sizes=[800,1000,120,100,4000]
    ...
    weight_decay = 1e-4
    mode = 'mup_pennington'
    n_train_sizes =[30000,10,50,100,300,15000,400,500,800,1000,2500,5000,8000,10000,20000,200,40000]
    ...
    #data_dir = f"stair_function/data/{experiment_name}"
    ...
    for params in worker_combinations:
        ...
        train_data_path = os.path.join(results_dir, f'train_data_h{params["hidden_size"]}_d{params["depth"]}_n{params["n_train"]}_lr{params["lr"]}_{timestamp}_rank{rank}.pt')
