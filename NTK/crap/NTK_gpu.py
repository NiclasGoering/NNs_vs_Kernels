...
def process_model_pair(initial_model_path: str, final_model_path: str, dataset_path: str, 
    ...
    try:
        ...
        print(f"Processing initial model: {initial_model_path}")
        ...
        # Process final model
        print(f"Processing final model: {final_model_path}")
...
def main():
    # Configuration
    models_dir = "/mnt/users/goringn/NNs_vs_Kernels/stair_function/results/msp_1601_NTK_norm_mup"  # Replace with your directory
    save_dir = os.path.join(models_dir, "kernel_analysis")
    ...
    for match in matches:
        try:
            ...
            failed += 1
            print(f"Error processing {match['config']}: {str(e)}")
